...
@injectable
class GetWeatherForFiveDaysUsecase
    extends DefaultUseCase<GetWeatherInput, WeatherForFiveDaysModel> {
  final WeatherRepository repository;

  GetWeatherForFiveDaysUsecase(this.repository);

  @override
  Future<WeatherForFiveDaysModel> run(
    GetWeatherInput input,
    DataType dataType,
  ) {
    return repository.getWeatherReportForFiveDays(input);
  }
}
